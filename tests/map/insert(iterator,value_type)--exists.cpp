...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   insert(iterator,value_type)--exists.cpp            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: vfurmane <vfurmane@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/06/27 20:01:57 by vfurmane          #+#    #+#             */
/*   Updated: 2022/06/27 21:52:11 by vfurmane         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	iterator ret = obj.insert(--obj.end(), NAMESPACE::make_pair(4, 2.7182f));
	std::cout << "size()  : " << obj.size() << std::endl;
	std::cout << "[4]     : " << obj[4] << std::endl;
	std::cout << "ret     : " << *ret << std::endl;
	std::cout << "--end() : " << *--obj.end() << std::endl;
}
