...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   equal_range(Key)--end.cpp                          :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: vfurmane <vfurmane@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/06/28 10:48:08 by vfurmane          #+#    #+#             */
/*   Updated: 2022/06/28 14:05:56 by vfurmane         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	NAMESPACE::pair<iterator, iterator>	ret = obj.equal_range(5);
	for (iterator it = ret.first; it != ret.second; ++it)
		std::cout << *it << std::endl;
	std::cout << "first == second ? " << (ret.first == ret.second) << std::endl;
	std::cout << "second == end() ? " << (ret.second == obj.end()) << std::endl;
}
