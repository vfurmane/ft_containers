...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   insert(iterator,value_type).cpp                    :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: vfurmane <vfurmane@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/06/27 20:01:57 by vfurmane          #+#    #+#             */
/*   Updated: 2022/06/27 21:52:50 by vfurmane         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	iterator ret = obj.insert(obj.begin(), NAMESPACE::make_pair(0, 3.1415f));
	std::cout << "size()  : " << obj.size() << std::endl;
	std::cout << "[0]     : " << obj[0] << std::endl;
