...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   insert(iterator,value_type)--mid.cpp               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: vfurmane <vfurmane@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/06/27 20:01:57 by vfurmane          #+#    #+#             */
/*   Updated: 2022/06/27 21:52:28 by vfurmane         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	iterator ret = obj.insert(++obj.begin(), NAMESPACE::make_pair(1, 3.1415f));
	std::cout << "size()    : " << obj.size() << std::endl;
	std::cout << "[1]       : " << obj[1] << std::endl;
