...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   equal_range(Key)--underflow.cpp                    :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: vfurmane <vfurmane@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/06/28 10:48:08 by vfurmane          #+#    #+#             */
/*   Updated: 2022/06/28 14:35:58 by vfurmane         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	NAMESPACE::pair<iterator, iterator>	ret = obj.equal_range(0);
	std::cout << "first == second  ? " << (ret.first == ret.second) << std::endl;
	std::cout << "first == begin() ? " << (ret.first == obj.begin()) << std::endl;
}
